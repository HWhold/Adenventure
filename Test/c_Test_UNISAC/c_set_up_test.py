...
def load_Experiments(name_group, fit_extrapolation):
    ...
    path_empty = 'Data_test/03_Experiments_'
    path_to_ctc2 = '.xlsx'
...
def load_Data(name_group, model):
    ...
    Solutes = pd.read_excel('Data_test/03_Molecules.xlsx', sheet_name= name_group, index_col ="Material")
    
    # load information about the solvents
    # Columns: Material, Formula Smiles, CAS, Source MPT, MPT °C, Source HFUS, HFUS J/mol
    Solvents = pd.read_excel('Data_test/03_Molecules.xlsx', sheet_name= 'Solvents', index_col ="Material")
    ...
    if model == 'UNIFAC':
        ...
        path_empty = 'Data_test/03_StructuralInformation_'
...
def load_Database(name_group, model):
    ...
    database = {}
    path_empty = 'Data_test/03_database_'
    path_to_ctc2 = '.xlsx'
